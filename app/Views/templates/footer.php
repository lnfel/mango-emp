<!--
  ...
  -->
  <script src="codebase/assets/js/codebase.core.min.js"></script>
  ...
  -->
  <script src="codebase/assets/js/codebase.app.min.js"></script>

  <!-- Page JS Plugins -->
  <script src="codebase/assets/js/plugins/chartjs/Chart.bundle.min.js"></script>
  <script src="codebase/assets/js/plugins/slick/slick.min.js"></script>

  <!-- Page JS Code -->
  <script src="codebase/assets/js/pages/be_pages_dashboard.min.js"></script>
</body>
</html>