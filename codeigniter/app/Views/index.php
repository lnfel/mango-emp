            ...
            <div class="content-header-section align-parent">
                ...
                <div class="content-header-item">
                    <a class="img-link mr-5" href="be_pages_generic_profile.html">
                        <img class="img-avatar img-avatar32" src="public/codebase/assets/media/avatars/avatar15.jpg" alt="">
                    </a>
                    ...
                    <ul class="nav-users push">
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="public/codebase/assets/media/avatars/avatar2.jpg" alt="">
                        ...
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="public/codebase/assets/media/avatars/avatar11.jpg" alt="">
                        ...
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="public/codebase/assets/media/avatars/avatar1.jpg" alt="">
                        ...
                        <li>
                            <a href="be_pages_generic_profile.html">
                                <img class="img-avatar" src="public/codebase/assets/media/avatars/avatar13.jpg" alt="">
            ...
            <div class="content-side content-side-full content-side-user px-10 align-parent">
                ...
                <div class="sidebar-mini-hidden-b text-center">
                    <a class="img-link" href="be_pages_generic_profile.html">
                        <img class="img-avatar" src="public/codebase/assets/media/avatars/avatar15.jpg" alt="">
                    </a>
                ...
                <div class="btn-group" role="group">
                    ...
                    <div class="dropdown-menu min-width-300" aria-labelledby="page-header-options-dropdown">
                        ...
                        <div class="row no-gutters text-center mb-5">
                            ...
                            <div class="col-2 mb-5">
                                <a class="text-elegance" data-toggle="theme" data-theme="public/codebase/assets/css/themes/elegance.min.css" href="javascript:void(0)">
                                    <i class="fa fa-2x fa-circle"></i>
                                </a>
                            </div>
                            <div class="col-2 mb-5">
                                <a class="text-pulse" data-toggle="theme" data-theme="public/codebase/assets/css/themes/pulse.min.css" href="javascript:void(0)">
                                    <i class="fa fa-2x fa-circle"></i>
                                </a>
                            </div>
                            <div class="col-2 mb-5">
                                <a class="text-flat" data-toggle="theme" data-theme="public/codebase/assets/css/themes/flat.min.css" href="javascript:void(0)">
                                    <i class="fa fa-2x fa-circle"></i>
                                </a>
                            </div>
                            <div class="col-2 mb-5">
                                <a class="text-corporate" data-toggle="theme" data-theme="public/codebase/assets/css/themes/corporate.min.css" href="javascript:void(0)">
                                    <i class="fa fa-2x fa-circle"></i>
                                </a>
                            </div>
                            <div class="col-2 mb-5">
                                <a class="text-earth" data-toggle="theme" data-theme="public/codebase/assets/css/themes/earth.min.css" href="javascript:void(0)">
                                    <i class="fa fa-2x fa-circle"></i>
                                </a>
                            </div>
                        </div>
...
<div class="modal fade" id="modal-onboarding" tabindex="-1" role="dialog" aria-labelledby="modal-onboarding" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-popout" role="document">
        <div class="modal-content rounded">
            <div class="block block-rounded block-transparent mb-0 bg-pattern" style="background-image: url('public/codebase/assets/media/various/bg-pattern-inverse.png');">
